...
@click.option(
    ...
    "pieline to train and deploy a model ('deply'),or to"
...
def run_deployment(config: str, min_accuracy: float):
    ...
    deploy=config==DEPLOY_AND_PREDICT
    ...
    if existing_services:
        ...
        if service.is_running:
            print(
                ...
                f"[italic_green] zenml model-deployer model delete"
            )

        elif service.is_failed:
            print(
                f"THE MLflow prediction server is in failed state:\n"
        ...
        print(
            ...
            "the same commnad with the '--deploy' argumnet to deploy a model."
        ) 
